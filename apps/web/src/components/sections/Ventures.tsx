    ...
    <section id="ventures" className="w-full py-24 px-6 border-t border-black/5 dark:border-white/5 transition-colors duration-300">
      <div className="max-w-5xl mx-auto">
        <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <Link href="/ventures" className="text-sm font-medium text-zinc-900 dark:text-zinc-100 hover:text-black dark:hover:text-white flex items-center transition-all bg-black/[0.05] dark:bg-white/[0.05] hover:bg-black/[0.08] dark:hover:bg-white/[0.08] px-5 py-2.5 rounded-full border border-black/10 dark:border-white/10 active:scale-[0.98] group">
            View All Projects <ArrowUpRight className="w-4 h-4 ml-1 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform" />
          </Link>
        </div>
