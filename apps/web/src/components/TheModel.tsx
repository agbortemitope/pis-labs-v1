...
import { BookOpen, Terminal, Users } from 'lucide-react';
...
const PillarCard: React.FC<PillarCardProps> = ({ title, subtitle, icon, features }) => (
  <div className="flex flex-col p-8 rounded-3xl border border-black/5 dark:border-white/10 bg-zinc-50 dark:bg-[#1C1C1E] backdrop-blur-xl shadow-lg dark:shadow-[0_0_40px_rgba(255,255,255,0.02)] hover:bg-zinc-100 dark:hover:bg-[#242426] transition-colors duration-300">
